---
title: Settings
description: Configure pgpilot appearance and language preferences.
---
...
![Settings — Catppuccin theme](/pgpilot/screenshots/settings--catppuccin.png)
...
![Settings — USSR theme](/pgpilot/screenshots/settings--ussr.png)
