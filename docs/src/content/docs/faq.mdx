---
title: FAQ
description: Frequently asked questions about pgpilot and OpenPGP.
---
...
See [Installation](/pgpilot/installation/) — verify GnuPG and `pinentry` are installed.

### Password prompt doesn't appear

See [Troubleshooting](/pgpilot/troubleshooting/) — pinentry section.

### Keys won't import

Check [Troubleshooting](/pgpilot/troubleshooting/) — import section.

### YubiKey not detected

See [Troubleshooting](/pgpilot/troubleshooting/) — YubiKey section.

---

## More questions?

- See [Troubleshooting](/pgpilot/troubleshooting/) for common issues
