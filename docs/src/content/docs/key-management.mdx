...
description: Create, import, export, delete, and manage your PGP keys in pgpilot.
---

Detailed workflows for managing GPG keys with pgpilot.

![My Keys view — Catppuccin theme](/pgpilot/screenshots/my-keys--catppuccin.png)
...
Subkeys expire by default (after 1, 2, or 5 years). Renewal extends the expiry date.
...
- Encrypt files for contacts — see [File Operations](/pgpilot/file-operations/)
- Use SSH with your Auth subkey — see [YubiKey / Smartcard](/pgpilot/smartcard/) (SSH section)
- Rotate keys on hardware — see [YubiKey / Smartcard](/pgpilot/smartcard/)
- Troubleshoot issues — see [Troubleshooting](/pgpilot/troubleshooting/)
