---
title: YubiKey & Smartcard
description: Store your subkeys on hardware for enhanced security.
---

Store your subkeys on hardware for enhanced security.

![Health check view — Catppuccin theme](/pgpilot/screenshots/health--catppuccin.png)
...
- `scdaemon` running (usually automatic; see [Troubleshooting](/pgpilot/troubleshooting/))
...
- See [Troubleshooting](/pgpilot/troubleshooting/) for scdaemon issues
...
1. **Back up your key**: Click **Backup** first (see [Key Management](/pgpilot/key-management/))
...
- If error, see [Troubleshooting](/pgpilot/troubleshooting/) — scdaemon section
...
- See [Troubleshooting](/pgpilot/troubleshooting/) — pinentry/scdaemon issues
...
1. **Back up before migration**
   - Always export secret key backup (see [Key Management](/pgpilot/key-management/))
...
- Learn about encryption & signing — see [File Operations](/pgpilot/file-operations/)
- Publish keys with migrated subkeys — see [Keyserver & Sharing](/pgpilot/keyserver/)
- Diagnose issues — see [Troubleshooting](/pgpilot/troubleshooting/)
