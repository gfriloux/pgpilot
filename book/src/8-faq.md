...
See [Troubleshooting](9-troubleshooting.md) — pinentry section.

### Keys won't import

Check [Troubleshooting](9-troubleshooting.md) — import section.

### YubiKey not detected

See [Troubleshooting](9-troubleshooting.md) — YubiKey section.

---

## More questions?

- See [Troubleshooting](9-troubleshooting.md) for common issues
- See [Security](10-security.md) for threat models
